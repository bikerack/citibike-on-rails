  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved station as @station" do
        ...
        post :create, {:station => { "address" => "invalid value" }}, valid_session
        assigns(:station).should be_a_new(Station)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested station" do
        ...
        Station.any_instance.should_receive(:update).with({ "address" => "MyString" })
        put :update, {:id => station.to_param, :station => { "address" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the station as @station" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Station.any_instance.stub(:save).and_return(false)
        put :update, {:id => station.to_param, :station => { "address" => "invalid value" }}, valid_session
        assigns(:station).should eq(station)
      end
